...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //判断是否第一次启动
    if (![[NSUserDefaults standardUserDefaults]boolForKey:@"firstLogin12"]) {
        [[NSUserDefaults standardUserDefaults]setBool:YES forKey:@"firstLogin12"];
    ...
    }else if(![[NSUserDefaults standardUserDefaults]objectForKey:@"isLogin"]){
